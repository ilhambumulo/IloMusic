...
from GeezProject.config import ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL,BOT_USERNAME, OWNER
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🎁 Donate", url=f"https://t.me/iamnibng")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📷 Instagram', url=f"https://instagram.com/ilhambumulo_")],
